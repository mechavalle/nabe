...
//Your E-mail
$your_email = 'il.diabolo@gmail.com';
...
if(isset($_POST['name'])) 
	...
	if(!empty($_POST['telephone']))
		$telephone      = stripslashes(strip_tags(trim($_POST['telephone'])));

	if(!empty($_POST['puesto']))
		$puesto      = stripslashes(strip_tags(trim($_POST['puesto'])));

	if(!empty($_POST['tipo']))
		$tipo      = stripslashes(strip_tags(trim($_POST['tipo'])));
	else
		$tipo=1;
