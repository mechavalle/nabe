...
switch($menu)
    ...
    case "tecnologia": $ctecnologia="class='active'"; break;
					...
					<div class="nav-wrap">
						...
						<nav class="top-nav">
							<ul class="nav sf-menu">
								...
								<!-- blog -->
								<li>
									<a href="blog-left.html">Evaluaciones</a>
									<ul>
										<li>
								...
								<!-- gallery -->
								<li>
									<a href="gallery-regular.html">Clientes</a>
									<ul>
										<li>
